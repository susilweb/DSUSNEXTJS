          ...
          <div className="row p-lg-6">
            <div className="col-lg-6 align-self-center">
              <div className="side-heding-new">
                ...
                <p>
                Being a Microsoft Gold Partner, our team will ensure to efficiently manage your sales processes, enable omnichannel efficiency, and drive improved customer support model through <a href="/products/microsoft-dynamics-365">Microsoft Dynamics 365</a> CRM.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-5 align-self-center">
              <div className="commen-rit-info">
                ...
                <p>
                  ...
                  customers' issues and fix them <a target="_blank" href="/products/microsoft-dynamics-365-ai/">leveraging AI insights</a> & IoT
